...
const searchServiceListingsController = new serviceListingController.SearchServiceListingsController(); // New controller

router.post('/', (req, res) => createServiceListingController.createServiceListing(req, res));
router.get('/search', (req, res) => searchServiceListingsController.searchListings(req, res)); // New search route
